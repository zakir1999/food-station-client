  ...
  return (
    <div>
      <div
        ...
        style={{
          backgroundImage: "url(https://i.ibb.co/PtkvKd3/offer-image-1.jpg)",
        }}
      >
        ...
        <div className="hero-content text-center text-neutral-content">
          <div className="max-w-md">
            ...
            <p className="mb-5">
              {" "}
              Immerse yourself in a world of culinary artistry, where each dish
              is meticulously crafted to deliver an unforgettable dining
              experience. From the first bite to the last, savor the flavors,
              textures, and creativity that make every moment at our restaurant
              truly exceptional.
            </p>
            <button
              to="/allfood"
